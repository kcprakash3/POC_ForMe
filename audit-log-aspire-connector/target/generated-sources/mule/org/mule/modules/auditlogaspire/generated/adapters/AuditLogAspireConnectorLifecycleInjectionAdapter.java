...
/**
 * A <code>AuditLogAspireConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link AuditLogAspireConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.8.0", date = "2016-08-10T02:18:19+05:30", comments = "Build UNNAMED.2762.e3b1307")
public class AuditLogAspireConnectorLifecycleInjectionAdapter
    extends AuditLogAspireConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(AuditLogAspireConnectorLifecycleInjectionAdapter.class);
